...
def create_lambda_params_constrained_pade(y0,y1,dfdy1 = None):
    """
    ...
    """
    if(dfdy1 is None):
        pade = lambda x,a,b : constrained_pade(x,a,b,y0,y1)
        coeffs = lambda a,b : constrained_pade_coeff(a,b,y0,y1)
    else:
        pade = lambda x,a,b : constrained_pade_w_grad(x,a,b,y0,y1,dfdy1)
        coeffs = lambda a,b : constrained_pade_coeff_w_grad(a,b,y0,y1,dfdy1)
    return pade,coeffs
...
def constrained_pade(x,a,b,f0,f1):
    """
...
def constrained_pade_coeff(a,b,f0,f1):
    """
